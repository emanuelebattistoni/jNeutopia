...
public class AssetSetter {
	...
	public void setObject () {
		int i =0;
		int mapNum=0;
		gp.obj[mapNum][i] = new OBJ_Chest(gp, new OBJ_Coin(gp));
		...
		gp.obj[mapNum][i].worldY = gp.tileSize*6;
		i++;
		gp.obj[mapNum][i] = new OBJ_Chest(gp, new OBJ_Bomb(gp));
		gp.obj[mapNum][i].worldX = gp.tileSize*11;
		gp.obj[mapNum][i].worldY = gp.tileSize*6;
		i++;
		mapNum=2;
		...
		i++;
		mapNum=6;
		gp.obj[mapNum][i] = new OBJ_Chest(gp, new OBJ_Crystalball(gp));
		gp.obj[mapNum][i].worldX = gp.tileSize*7;
		gp.obj[mapNum][i].worldY = gp.tileSize*40;
		i++;
		gp.obj[mapNum][i] = new OBJ_Chest(gp, new OBJ_Key(gp));//inserire armatura
		gp.obj[mapNum][i].worldX = gp.tileSize*7;
