...
public class MON_Fly extends Entity {
    ...
    public void getImage() {
        ...
        down1 = setup("/monster/fly1", gp.tileSize, gp.tileSize);
        down2 = setup("/monster/fly2", gp.tileSize, gp.tileSize);
        left1 = setup("/monster/fly1", gp.tileSize, gp.tileSize);
        left2 = setup("/monster/fly2", gp.tileSize, gp.tileSize);
        right1 = setup("/monster/fly1", gp.tileSize, gp.tileSize);
        right2 = setup("/monster/fly2", gp.tileSize, gp.tileSize);
    }
