...
public class MON_Pslime extends Entity {
    ...
    public MON_Pslime (GamePanel gp) {
        super(gp);
        this.gp = gp;
        type = 2;
        name = "slime";
    ...
    public void getImage() {
        up1 = setup("/monster/pslime1", gp.tileSize, gp.tileSize);
        up2 = setup("/monster/pslime3", gp.tileSize, gp.tileSize);
        down1 = up1;
        down2 = up2;
        left1 = up1;
        left2 = up2;
        right1 = up1;
        right2 = up2;
        inv1 = setup("/monster/pslimeInvincible", gp.tileSize, gp.tileSize);
        inv2 = setup("/monster/pslimeInvincibleR", gp.tileSize, gp.tileSize);
        inv3 = setup("/monster/pslimeInvincible2", gp.tileSize, gp.tileSize);
        inv4 = setup("/monster/pslimeInvincibleR2", gp.tileSize, gp.tileSize);
    }
    ...
    public void setAction() {
        if (skillActive == true) {
            ...
            SaveStartPosition();
            if (startSaved == true && skillActive == false) {
                ...
                else if (actionLockCounter > 50 && actionLockCounter < 65) {
                    if (actionLockCounter < 57) {
                        jumpOffset += 4;
                    } else {
                        jumpOffset -= 4;
                    }
                }
                else if (actionLockCounter >= 65) {
                    actionLockCounter = 0; 
                    speed = 0; 
                    jumpOffset = 0;
                }
    ...
    public void draw(Graphics2D g2) {
        ...
        if (screenX + gp.tileSize > 0 && screenX < gp.screenWidth &&
            ...
            if (image != null) {
                g2.drawImage(image, screenX, screenY - jumpOffset, null);
            }
