...
import object.OBJ_Coin;
	...
	public class MON_Pslime extends Entity {
	    ...
	    public void getImage() {
	        ...
	        down1 = setup("/monster/pslime1", gp.tileSize, gp.tileSize);
	        down2 = setup("/monster/pslime3", gp.tileSize, gp.tileSize);
	        left1 = setup("/monster/pslime1", gp.tileSize, gp.tileSize);
	        left2 = setup("/monster/pslime3", gp.tileSize, gp.tileSize);
	        right1 = setup("/monster/pslime1", gp.tileSize, gp.tileSize);
	        right2 = setup("/monster/pslime3", gp.tileSize, gp.tileSize);
	    }
